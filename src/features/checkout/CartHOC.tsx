...
const CartHOC: FC = () => {
    ...
    return (
        <Animated.View
            style={[
                isExpand ?
                    styles.expandedCartContainer : styles.cartContainer,
                animatedStyle,
                {
            ...
            {carts?.length > 1 && !isExpand && (
                <TouchableOpacity
                    ...
                    <CustomText
                        style={{ top: -1 }}
                        color={Colors.active} fontSize={9} fontFamily="Okra-Medium">
                        +{carts?.length - 1} more
                    </CustomText>
                    <Icon
                        iconFamily="Ionicons"
            ...
            {Platform.OS === 'ios' && isExpand && (
                <BlurView
                    style={styles.absolute} blurType="light" blurAmount={10} />
            )}
